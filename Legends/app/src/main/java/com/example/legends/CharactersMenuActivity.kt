...
class CharactersMenuActivity : ComponentActivity() {
    ...
    fun View(modifier : Modifier, route: String) {
        ...
        NavHost(navController, Routes.LazyVerticalGrid.choice) {
            composable(Routes.List.choice) {ViewInList(iconViewModel,navController, modifier)}
            ...
            composable(Routes.LazyVerticalGrid.choice) { ViewInLazyVerticalGrid(iconViewModel, navController, modifier)
            }
        }
        ...
        LazyVerticalGrid (columns = GridCells.Fixed(2),modifier = modifier) {
            ...
            items(vm.icons.value) { icon ->
                Card (
                    ...
                    content = { Column(Modifier.padding(16.dp)) {AsyncImage(model= "https://ddragon.leagueoflegends.com/cdn/13.16.1/img/champion/${icon.image.image}" , null)} }
                )
